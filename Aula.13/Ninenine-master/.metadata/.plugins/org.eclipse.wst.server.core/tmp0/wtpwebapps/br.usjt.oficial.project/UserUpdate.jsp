...
<body>
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a  href = "http://localhost:8080/br.usjt.oficial.project/AccessRead.jsp">Read</a></li>
...
<input type="text" class="form-control" name="stringPassword" id="stringPassword"
