...
<body>
	...
	<h3 class="page-header">Incluir User</h3>
<!-- Formulario para inclusao de clientes -->
<form action="UserCreate.do" method="post">
...
<div class="row">
<div class="form-group col-md-6">
<label for="fone">Type</label>
<input type="tel" class="form-control" name="stringType" id="stringType"
maxlength="15" pattern="" placeholder="">
</div>
