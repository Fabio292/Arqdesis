...
<body>
	...
	<h3 class="page-header">Alterar Ar Condicionado</h3>
<!-- Formulario para Alterar de Ar Condicionado -->
<form action="AirConditioningUpdate.do" method="post">
<!-- area de campos do form -->
<div class="row">
<div class="form-group col-md-12">
<label for="nome">Status</label>
<input type="text" class="form-control" name="booleanStatus" id="booleanStatus"
required maxlength="100" placeholder="Status">
</div>
</div>
