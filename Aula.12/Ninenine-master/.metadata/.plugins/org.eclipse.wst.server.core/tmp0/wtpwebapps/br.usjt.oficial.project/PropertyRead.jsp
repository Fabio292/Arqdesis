...
<body>
	...
	<h3 class="page-header">Read Property</h3>
<!-- Formulario para consulta de property -->
<form action="PropertyRead.do" method="post">
<!-- area de campos do form -->
<div class="row">
<div class="form-group col-md-12">
<label for="nome">Nome</label>
<input type="text" class="form-control" name="stringName" id="stringName"
required maxlength="100" placeholder="nom ">
</div>
</div>
<div class="row">
<div class="form-group col-md-6">
<label for="fone">Andar</label>
<input type="tel" class="form-control" name="stringAndar" id="stringAndar"
maxlength="15" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}" placeholder="">
</div>
