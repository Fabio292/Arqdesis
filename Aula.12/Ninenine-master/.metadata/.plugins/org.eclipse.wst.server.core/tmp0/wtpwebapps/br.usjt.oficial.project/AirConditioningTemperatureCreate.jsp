...
<body>
	...
	<h3 class="page-header">Criar Ar Condicionado</h3>
<!-- Formulario para inclusao de Ar Condicionado -->
<form action="AirConditioningCreate.do" method="post">
