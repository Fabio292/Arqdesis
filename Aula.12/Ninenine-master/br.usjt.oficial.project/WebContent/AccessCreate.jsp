...
<body>
	...
	<h3 class="page-header">Access Insert</h3>
...
<input type="text" class="form-control" name="stringCheckInDay" id="stringCheckInDay"
...
<div class="col-md-12">
<button type="submit" class="btn btn-primary" name="AccessCreateCommand"
